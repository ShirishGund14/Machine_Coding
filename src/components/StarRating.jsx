    ...
    <div className='bg-gray-700 h-screen w-full p-5 flex justify-center items-center'>
      {
        stars.map((star, index) => {
          return (
            <div className='w-1/2  h-40 bg-gray-900 p-3 flex items-center justify-center '>
              <span className={`text-gray-300 text-4xl cursor-pointer ${ (index<=hoverval || (hoverval===0 && index<=selectstar)) ?'text-yellow-500': ''} `} 
              key={index}  
